...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Scaleway) DeepCopyInto(out *Scaleway) {
	*out = *in
	if in.Auth != nil {
		in, out := &in.Auth, &out.Auth
		*out = new(ScalewayAuth)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Scaleway.
func (in *Scaleway) DeepCopy() *Scaleway {
	if in == nil {
		return nil
	}
	out := new(Scaleway)
